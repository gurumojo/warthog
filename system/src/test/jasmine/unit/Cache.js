		...
		describe('method', function(){
			...
			describe('set', function(){
				it('accepts a string for the first parameter', function(){
					expect(this.cache.set).toThrow(new TypeError('string parameter required'));
			...
			describe('filter', function(){
				...
				it('accepts an object for the first parameter', function(){
					expect(this.cache.filter).toThrow(new TypeError('object parameter required'));
